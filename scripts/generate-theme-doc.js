...
\`\`\`md
![Anurag's GitHub stats](https://cattr91.vercel.app/api?username=cattr91&theme=dark&show_icons=true)
\`\`\`
...
[add-theme]: https://github.com/cattr91/cattr91/edit/master/themes/index.js

Want to add a new theme? Consider reading the [contribution guidelines](../CONTRIBUTING.md#themes-contribution) :D
`;

const createRepoMdLink = (theme) => {
  return `\n[${theme}_repo]: https://cattr91.vercel.app/api/pin/?username=cattr91&repo=cattr91&cache_seconds=86400&theme=${theme}`;
};
const createStatMdLink = (theme) => {
  return `\n[${theme}]: https://cattr91.vercel.app/api?username=cattr91&show_icons=true&hide=contribs,prs&cache_seconds=86400&theme=${theme}`;
};

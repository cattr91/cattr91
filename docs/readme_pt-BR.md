 ...
 <p align="center">Adicione suas estatísticas no GitHub geradas dinamicamente em seus readmes!</p>
  ...
  <p align="center">
    <a href="https://github.com/cattr91/cattr91/actions">
      <img alt="Testes aprovados" src="https://github.com/cattr91/cattr91/workflows/Test/badge.svg" />
    </a>
  ...
  <p align="center">
    ...
    ·
    <a href="https://github.com/cattr91/cattr91/issues/new?assignees=&labels=bug&projects=&template=bug_report.yml">Reportar erros</a>
    ·
    <a href="https://github.com/cattr91/cattr91/issues/new?assignees=&labels=enhancement&projects=&template=feature_request.yml">Solicitar recursos</a>
  </p>
  <p align="center">
...
<p align="center">Gostou do projeto? Por favor considere <a href="https://www.paypal.me/cattr91">fazer uma doação</a> para ajudar a melhorá-lo!
...
Como a API do GitHub permite apenas 5 mil solicitações por hora, é possível que minha `https://cattr91.vercel.app/api` atinja a cota limite. Se hospedar em seu próprio servidor Vercel, não precisará se preocupar com nada. Clique no botão de implantação para começar!

Nota: Desde [#58](https://github.com/cattr91/cattr91/pull/58) há possibilidade de lidar com mais de 5 mil chamadas por hora, sem interrupções :D
...
- Dando os devidos créditos ao usar cattr91 no seu README.me, adicionando uma referência ao projeto :D
- Dando uma estrela (Starring) e compartilhando o projeto 🚀
- [![paypal.me/cattr91](https://ionicabizau.github.io/badges/paypal.svg)](https://www.paypal.me/cattr91) - Você pode fazer doações únicas via PayPal. Provavelmente vou comprar um ~~café~~ chá. :tea:

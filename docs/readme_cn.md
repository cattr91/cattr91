<p align="center">
 ...
 <p align="center">在你的 README 中获取动态生成的 GitHub 统计信息！</p>
  ...
  <p align="center">
    ...
    ·
    <a href="https://github.com/cattr91/cattr91/issues/new?assignees=&labels=bug&projects=&template=bug_report.yml">报告 Bug</a>
    ·
    <a href="https://github.com/cattr91/cattr91/issues/new?assignees=&labels=enhancement&projects=&template=feature_request.yml">请求增加功能</a>
  </p>
  <p align="center">
...
<p align="center">喜欢这个项目？请考虑<a href="https://www.paypal.me/cattr91">捐赠</a>来帮助它完善！
...
端点: `api/pin?username=cattr91&repo=cattr91`
...
_注意：热门语言并不表示我的技能水平或类似的水平，它是用来衡量用户在 github 上拥有最多代码的语言的一项指标，它是 cattr91 的新特性_

### 使用细则

将此代码复制粘贴到您的 `README.md` 文件中，并修改链接。

端点: `api/top-langs?username=cattr91`
...
因为 GitHub 的 API 每个小时只允许 5 千次请求，我的 `https://cattr91.vercel.app/api` 很有可能会触发限制。如果你将其托管在自己的 Vercel 服务器上，那么你就不必为此担心。点击 deploy 按钮来开始你的部署！

注意: 从 [#58](https://github.com/cattr91/cattr91/pull/58) 开始，我们应该能够处理超过 5 千次的请求，并且不会出现宕机问题 :D
...
- 在你的 readme 中使用 cattr91 时，链接指向这里 :D
- Star 并 分享这个项目 :rocket:
- [![paypal.me/cattr91](https://ionicabizau.github.io/badges/paypal.svg)](https://www.paypal.me/cattr91) - 你可以通过 PayPal 一次性捐款. 我多半会买一杯 ~~咖啡~~ 茶. :tea:

<p align="center">
 ...
 <p align="center">동적으로 생성되는 GitHub 사용량 통계를 여러분의 README 에 추가해보세요!</p>
  ...
  <p align="center">
    ...
    ·
    <a href="https://github.com/cattr91/cattr91/issues/new?assignees=&labels=bug&projects=&template=bug_report.yml">버그 제보하기</a>
    ·
    <a href="https://github.com/cattr91/cattr91/issues/new?assignees=&labels=enhancement&projects=&template=feature_request.yml">기능 추가 요청하기</a>
  </p>
  <p align="center">
...
<p align="center">기능들이 마음에 드시나요? 괜찮으시다면, 서비스 개선을 위해 <a href="https://www.paypal.me/cattr91">기부</a>를 고려해주세요!
...
엔드 포인트: `api/pin?username=cattr91&repo=cattr91`
...
[![GitHub 저장소 핀 카드](https://cattr91.vercel.app/api/pin/?username=cattr91&repo=cattr91)](https://github.com/cattr91/cattr91)

[show_owner](#커스터마이징) 속성을 통해 저장소 소유자의 닉네임 표시 여부를 설정할 수 있어요.

[![GitHub 저장소 핀 카드](https://cattr91.vercel.app/api/pin/?username=cattr91&repo=cattr91&show_owner=true)](https://github.com/cattr91/cattr91)
...
엔드 포인트: `api/top-langs?username=cattr91`
...
[![언어 사용량 통계](https://cattr91.vercel.app/api/top-langs/?username=cattr91)](https://github.com/cattr91/cattr91)

- 컴팩트한 레이아웃

[![언어 사용량 통계](https://cattr91.vercel.app/api/top-langs/?username=cattr91&layout=compact)](https://github.com/cattr91/cattr91)
...
[![Harlok 님의 wakatime 통계](https://cattr91.vercel.app/api/wakatime?username=ffflabs)](https://github.com/cattr91/cattr91)

[![Harlok 님의 wakatime 통계](https://cattr91.vercel.app/api/wakatime?username=ffflabs&hide_progress=true)](https://github.com/cattr91/cattr91)

- 컴팩트한 레이아웃

[![Harlok 님의 wakatime 통계](https://cattr91.vercel.app/api/wakatime?username=ffflabs&layout=compact)](https://github.com/cattr91/cattr91)
...
![Anurag 님의 GitHub 사용량 통계](https://cattr91.vercel.app/api?username=cattr91)

- 특정 통계 내용 숨김

![Anurag 님의 GitHub 사용량 통계](https://cattr91.vercel.app/api?username=cattr91&hide=contribs,issues)

- 아이콘 표시

![Anurag 님의 GitHub 사용량 통계](https://cattr91.vercel.app/api?username=cattr91&hide=issues&show_icons=true)

- 전체 커밋 포함 시

![Anurag 님의 GitHub 사용량 통계](https://cattr91.vercel.app/api?username=cattr91&include_all_commits=true)

- 테마들

[내장 테마](#themes) 에서 직접 선택해보세요

![Anurag 님의 GitHub 사용량 통계](https://cattr91.vercel.app/api?username=cattr91&show_icons=true&theme=radical)

- 그라데이션 주기

![Anurag 님의 GitHub 사용량 통계](https://cattr91.vercel.app/api?username=cattr91&bg_color=30,e96443,904e95&title_color=fff&text_color=fff)

- 통계 카드 커스터마이징하기

![Anurag 님의 GitHub 사용량 통계](https://cattr91.vercel.app/api/?username=cattr91&show_icons=true&title_color=fff&icon_color=79ff97&text_color=9f9f9f&bg_color=151515)

- 언어 사용 지역 설정하기

![Anurag 님의 GitHub 사용량 통계](https://cattr91.vercel.app/api/?username=cattr91&locale=kr)

- 저장소 핀 커스터마이징하기

![Anurag 님의 GitHub 저장소 핀](https://cattr91.vercel.app/api/pin?username=cattr91&repo=cattr91&title_color=fff&icon_color=f9f9f9&text_color=9f9f9f&bg_color=151515)
...
[![Harlok 님의 WakaTime 카드](https://cattr91.vercel.app/api/wakatime?username=ffflabs)](https://github.com/cattr91/cattr91)
...
저의 `https://cattr91.vercel.app/api` 가 사용량 제한에 걸릴 위험이 생겼어요.

만약, 여러분이 Vercel server 에서 직접 호스트 하신다면, 걱정하실 일은 없을거에요.

아래의 버튼을 이용해 직접 배포해보세요!

참고: [#58](https://github.com/cattr91/cattr91/pull/58) 풀 리퀘스트 이후로, 저희는 5,000 개 이상의 요청을 처리할 수 있게 됐어요. 더이상 서버 다운에 대한 걱정은 노놉! :D

[![Vercel 에 배포하기](https://vercel.com/button)](https://vercel.com/import/project?template=https://github.com/cattr91/cattr91)
...
- cattr91 를 README 에 표시하실 때 확실한 도움을 주세요! 이 저장소로 링크를 걸어주시면 돼요! :D
- 이 프로젝트를 많이 공유해주시고, 즐겨찾기 해주세요! :rocket:
- [![paypal.me/cattr91](https://ionicabizau.github.io/badges/paypal.svg)](https://www.paypal.me/cattr91) - PayPal 을 이용해 1회성 도네이션을 해주실 수 있어요. 아마도 전 ~~커피, 아... 아니~~ 차를 사서 마시겠죠? ㅎ; :tea:

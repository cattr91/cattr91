<p align="center">
 ...
 <p align="center">Zeige dynamisch generierte GitHub-Statistiken in deinen Readmes!</p>
  ...
  <p align="center">
    ...
    ·
    <a href="https://github.com/cattr91/cattr91/issues/new?assignees=&labels=bug&projects=&template=bug_report.yml">Fehler melden</a>
    ·
    <a href="https://github.com/cattr91/cattr91/issues/new?assignees=&labels=enhancement&projects=&template=feature_request.yml">Funktion wünschen</a>
  </p>
  <p align="center">
...
<p align="center">Du magst das Projekt? Wie wäre es mit einer kleinen <a href="https://www.paypal.me/cattr91">Spende</a> um es weiterhin am Leben zu erhalten?
...
Endpunkt: `api/pin?username=cattr91&repo=cattr91`
...
Endpunkt: `api/top-langs?username=cattr91`
...
Da die GitHub API nur 5 Tsd. Aufrufe pro Stunde zulässt, kann es passieren, dass meine `https://cattr91.vercel.app/api` dieses Limit erreicht.
...
Hinweis: Seit [#58](https://github.com/cattr91/cattr91/pull/58) sollte es möglich sein, mehr als 5 Tsd Aufrufe pro Stunde ohne Downtimes zu verkraften :D
...
- [![paypal.me/cattr91](https://ionicabizau.github.io/badges/paypal.svg)](https://www.paypal.me/cattr91) - Du kannst einmalige Spenden via PayPal tätigen. Ich kaufe mir wahrscheinlich einen ~~Kaffee~~ Tee davon. :tea:
